...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Show admin request section only if not admin and not already requested
  const role = localStorage.getItem("role");
  if (role !== "admin" && !localStorage.getItem("adminRequested")) {
